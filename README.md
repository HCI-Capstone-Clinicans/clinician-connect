  ...
  ## Live Website
  https://hci-capstone-clinicans.github.io/clinician-connect/
  
  ## How To Run Code Locally
  1. Clone repository. Open terminal and run:
  ```
  git clone https://github.com/HCI-Capstone-Clinicans/clinician-connect.git
  ```
